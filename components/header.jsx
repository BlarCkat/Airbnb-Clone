...
const HeaderComponent = () => {
    return ( 
        <>
        <header className="z-50 sticky bg-white py-2 px-4 shadow-sm md:px-8 flex flex-row justify-between items-center">
            ...
            <div className="flex flex-row justify-between items-center rounded-full border-2 border-neutral-50 px-2 py-2 shadow-sm w-[50%]">
